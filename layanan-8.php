...
<html lang="en">
  ...
  <body>
    ...
    <section id="layanan">
      <div class="container">
        <h1>Layanan <span>Anak</span></h1>
        <div class="layanan-grid">
          <a><img src="asset/icon_penyakit_anak.png" /></a>
          <p>Silahkan isi form dibawah ini untuk membuat janji dengan dokter untuk melakukan Pelayanan Anak</p>
        </div>
        <?php
          include 'form-7.php'
          ?>
