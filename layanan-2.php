...
<html lang="en">
  ...
  <body>
    ...
    <section id="layanan">
      <div class="container">
        <h1>Layanan <span>Dokter Umum</span></h1>
        <div class="layanan-grid">
          <a><img src="asset/icon_dokter_umum.png" /></a>
          <p>Silahkan isi form dibawah ini untuk membuat janji dengan dokter untuk melakukan Pelayanan Dokter Umum</p>
        </div>
        <?php
          include 'form-1.php'
          ?>
