...
<html lang="en">
  ...
  <body>
    ...
    <section id="layanan">
      <div class="container">
        <h1>Layanan <span>Penyakit Dalam</span></h1>
        <div class="layanan-grid">
          <a><img src="asset/icon_penyakit_dalam.png" /></a>
          <p>Silahkan isi form dibawah ini untuk membuat janji dengan dokter untuk melakukan Pelayanan Penyakit Dalam</p>
        </div>
        <?php
          include 'form-8.php'
          ?>
