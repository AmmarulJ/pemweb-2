...
<html lang="en">
  ...
  <body>
    ...
    <section id="layanan">
      <div class="container">
        <h1>Layanan <span>Gigi Umum</span></h1>
        <div class="layanan-grid">
          <a><img src="asset/icon_gigi_umum.png" /></a>
          <p>Silahkan isi form dibawah ini untuk membuat janji dengan dokter untuk melakukan Pelayanan Gigi Umum</p>
        </div>
        <?php
          include 'form-2.php'
          ?>
