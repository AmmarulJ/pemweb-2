...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="layanan-I.css" />
  ...
  <body>
    ...
    <section id="layanan">
      <div class="container">
        <h1>Layanan <span>Bedah Umum</span></h1>
        <div class="layanan-grid">
          <a><img src="asset/icon_bedah_umum.png" /></a>
          <p>Silahkan isi form dibawah ini untuk membuat janji dengan dokter untuk melakukan Pelayanan Bedah Umum</p>
        </div>
        <?php
          include 'form.php'
          ?>
