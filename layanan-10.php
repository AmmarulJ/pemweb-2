...
<html lang="en">
  ...
  <body>
    ...
    <section id="layanan">
      <div class="container">
        <h1>Layanan <span>THT-KL</span></h1>
        <div class="layanan-grid">
          <a><img src="asset/icon_tht.png" /></a>
          <p>Silahkan isi form dibawah ini untuk membuat janji dengan dokter untuk melakukan Pelayanan THT-KL</p>
        </div>
        <?php
          include 'form-9.php'
          ?>
