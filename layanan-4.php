...
<html lang="en">
  ...
  <body>
    ...
    <section id="layanan">
      <div class="container">
        <h1>Layanan <span>Jantung</span></h1>
        <div class="layanan-grid">
          <a><img src="asset/icon_jantung.png" /></a>
          <p>Silahkan isi form dibawah ini untuk membuat janji dengan dokter untuk melakukan Pelayanan Jantung</p>
        </div>
        <?php
          include 'form-3.php'
          ?>
